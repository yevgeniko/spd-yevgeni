/****************************************************************************
** Meta object code from reading C++ file 'device_manager.hpp'
**
...
#error "The header file 'device_manager.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 14, 16), // "on_data_received"
QT_MOC_LITERAL(2, 31, 0) // ""

    },
    "DeviceManager\0on_data_received\0"
};
...
void DeviceManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_data_received(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
